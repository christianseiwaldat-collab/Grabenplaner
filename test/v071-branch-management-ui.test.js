...
test("v0.71 Block 7 UI: bestehende Views und View-Deep-Links bleiben kompatibel", () => {
  ...
  assert.match(requestedView, /\["startDashboard", "filialAdministration", "planning", "requests", "timeTracking", "vacations", "personnelAdministration", "salesAdministration", "salesAnalytics", "crm", "personnel", "loans", "branchOrders", "rightsDashboard", "settings"\]\.includes\(requestedView\)/);
