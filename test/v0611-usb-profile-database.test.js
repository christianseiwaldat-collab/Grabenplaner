...
test("USB-Profil erzeugt nur Stammdaten und setzt den Ersteller als Admin", () => {
  ...
  source.exec(`
    ...
    INSERT INTO employees (personnel_number,full_name,nickname,color,contracted_hours,fixed_workdays,position_id,time_confirmation_level,home_location_id,preferred_department_id,cost_center_id,active) VALUES ('101','Alex Beispiel','Alex','#123456',40,'','verkaufsmitarbeiter','A','18',1,'cc18',1),('500','Demo Person','Demo','#654321',30,'','verkaufsmitarbeiter','C','18',1,'cc18',1);
