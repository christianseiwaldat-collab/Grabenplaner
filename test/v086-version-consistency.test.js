...
test("v0.92.5: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.92.5-beta");
  ...
  assert.match(indexHtml, /v0\.92\.5 Beta/);
  ...
  assert.match(readme, /v0\.92\.5 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.5 Codespaces-Demo");
