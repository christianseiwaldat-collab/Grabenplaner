...
test("v0.92.17: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  ...
  assert.match(indexHtml, /v0\.92\.17 Beta/);
  ...
  assert.match(readme, /v0\.92\.17 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.17 Codespaces-Demo");
