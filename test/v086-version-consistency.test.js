...
test("v0.92.26: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  ...
  assert.match(indexHtml, /v0\.92\.26 Beta/);
  ...
  assert.match(readme, /v0\.92\.26 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.26 Codespaces-Demo");
