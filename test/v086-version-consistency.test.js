...
test("v0.88.3: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.88.3-beta");
  ...
  assert.match(indexHtml, /v0\.88\.3 Beta/);
  ...
  assert.match(readme, /v0\.88\.3 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.88.3 Codespaces-Demo");
  ...
  assert.match(versionLog, /v0\.88\.3 Beta/);
