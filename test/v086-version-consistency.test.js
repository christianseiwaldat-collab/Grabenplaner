...
test("v0.92.19: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  ...
  assert.match(indexHtml, /v0\.92\.19 Beta/);
  ...
  assert.match(readme, /v0\.92\.19 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.19 Codespaces-Demo");
