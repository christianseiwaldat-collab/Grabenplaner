...
test("v0.92.43: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  ...
  assert.match(indexHtml, /v0\.92\.43 Beta/);
  ...
  assert.match(readme, /v0\.92\.43 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.43 Codespaces-Demo");
