...
test("v0.91.5: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.91.5-beta");
  ...
  assert.match(indexHtml, /v0\.91\.5 Beta/);
  ...
  assert.match(readme, /v0\.91\.5 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.91.5 Codespaces-Demo");
