...
test("v0.92.46: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  ...
  assert.match(indexHtml, /v0\.92\.46 Beta/);
  ...
  assert.match(readme, /v0\.92\.46 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.46 Codespaces-Demo");
