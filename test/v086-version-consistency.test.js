...
test("v0.89: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.89.0-beta");
  ...
  assert.match(indexHtml, /v0\.89 Beta/);
  ...
  assert.match(readme, /v0\.89 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.89 Codespaces-Demo");
