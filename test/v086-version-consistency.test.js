...
test("v0.88: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.88.0-beta");
  ...
  assert.match(indexHtml, /v0\.88 Beta/);
  ...
  assert.match(readme, /v0\.88 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.88 Codespaces-Demo");
