...
test("v0.92.1: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.92.1-beta");
  ...
  assert.match(indexHtml, /v0\.92\.1 Beta/);
  ...
  assert.match(readme, /v0\.92\.1 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.92.1 Codespaces-Demo");
