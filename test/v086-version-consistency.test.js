...
test("v0.90.2: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.90.2-beta");
  ...
  assert.match(indexHtml, /v0\.90\.2 Beta/);
  ...
  assert.match(readme, /v0\.90\.2 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.90.2 Codespaces-Demo");
