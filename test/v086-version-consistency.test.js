...
test("v0.90.5: Serverpaket, UI und aktuelle Dokumentation bleiben konsistent", () => {
  const packageJson = JSON.parse(read("package.json"));
  assert.equal(packageJson.version, "0.90.5-beta");
  ...
  assert.match(indexHtml, /v0\.90\.5 Beta/);
  ...
  assert.match(readme, /v0\.90\.5 Beta/);
  ...
  assert.equal(devcontainer.name, "Grabenplaner v0.90.5 Codespaces-Demo");
  ...
  assert.match(versionLog, /v0\.90\.5 Beta/);
