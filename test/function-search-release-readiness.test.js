...
test("Block 5: alle Suchmodule sind versionsgebunden, paketfähig und persistenzfrei klassifiziert", () => {
  ...
  assert.equal(packageJson.version, "0.92.14-beta");
  assert.match(read("README.md"), /v0\.92\.14 Beta/);
  ...
  assert.equal(JSON.parse(read(".devcontainer/devcontainer.json")).name, "Grabenplaner v0.92.14 Codespaces-Demo");
