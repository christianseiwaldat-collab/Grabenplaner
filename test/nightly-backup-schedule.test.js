...
test('only a trusted matching version pair selects the single nightly schedule',()=>{
 ...
 for(const [core,installed,expected] of [[10,10,'single'],[9,10,'legacy'],[10,9,'legacy'],[8,10,'legacy'],[7,10,'legacy']])
 ...
 for(const bad of [{info:{uid:1000}},{info:{mode:0o666}},{info:{nlink:2}},{info:{isSymbolicLink:()=>true}},
  {info:{size:131073}},{alias:'/elsewhere'},{contract:{schemaVersion:2}},{contract:{moduleVersion:11}},{contract:{format:'other'}}]){
