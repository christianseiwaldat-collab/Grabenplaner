...
test("Block 5/7: der reale 1015er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 1015);
  assert.equal(portable.length, 909);
