...
test("Block 5/7: der reale 950er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 950);
  assert.equal(portable.length, 848);
