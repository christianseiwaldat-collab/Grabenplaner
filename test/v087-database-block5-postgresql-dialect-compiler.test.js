...
test("Block 5/7: der reale 1013er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 1013);
  assert.equal(portable.length, 907);
