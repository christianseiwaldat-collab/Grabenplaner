...
test("Block 5/7: der reale 1051er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 1051);
  assert.equal(portable.length, 945);
