...
test("Block 5/7: der reale 939er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 939);
  assert.equal(portable.length, 837);
