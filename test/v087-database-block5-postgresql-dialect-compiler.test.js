...
test("Block 5/7: der reale 928er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 928);
  assert.equal(portable.length, 826);
