...
test("Block 5/7: der reale 1069er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 1069);
  assert.equal(portable.length, 958);
