...
test("Block 5/7: der reale 1099er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 1099);
  assert.equal(portable.length, 988);
