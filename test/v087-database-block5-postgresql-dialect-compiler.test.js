...
test("Block 5/7: der reale 1048er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 1048);
  assert.equal(portable.length, 942);
