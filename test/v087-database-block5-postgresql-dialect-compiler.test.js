...
test("Block 5/7: der reale 891er SQLite-Katalog wird vollständig und geschlossen klassifiziert", () => {
  ...
  assert.equal(compiled.length, 891);
  assert.equal(portable.length, 789);
