...
test("runtime-v5 and offsite-v9 are the current package contracts", () => {
  ...
  assert.equal(JSON.parse(read("server-tools/linux/offsite/module-schema.json")).moduleVersion, 9);
});
