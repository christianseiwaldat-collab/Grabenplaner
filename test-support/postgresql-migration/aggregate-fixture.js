...
function aggregatePreview(){
  ...
  add('01.07.26-',140,67);add('01.07.25-',186,67);
  add('31.07.26',140,78);add('31.07.25',186,78);
  ...
  add('Seite: 1 von 1',29,555);add('03.08.26',760,555);
  return trustTradeFotoReportPages([{number:1,height,width:841.89,items}],{contentSha256:'b'.repeat(64),byteLength:1000,fileName:'synthetisch.pdf'});
}
