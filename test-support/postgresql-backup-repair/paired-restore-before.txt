...
function waitForRestoreTool(child,{name,commandNumber}) {
 // The isolated worker has a 30-minute total budget. A large pg_restore must
 // not retain the former 15-minute child limit inside that worker.
 const timeoutMs=name==='pg_restore'?30*60*1000:15*60*1000;
