...
function reportMarginPolicyFor(salesPolicy) {
  return ['cash-confirmed-20260907', 'cash-confirmed-20260910', 'cash-confirmed-20260911'].includes(salesPolicy?.id) && salesPolicy.currency === 'EUR' && salesPolicy.minorUnits === 2
