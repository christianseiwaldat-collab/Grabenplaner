...
function buildTradeFotoMasterView(inspected) {
  ...
  if (table.name === "KUNDEN") {
    view.customer = pick(source, { customerNumber: "KUND_NR", firstName: "VORNAME", lastName: "NACHNAME", street: "STRaße", addressSupplement: "AdressZusatz", postalCode: "PLZ", city: "ORT", country: "Land", vatId: "UStID", birthCivilDateTime: "Geburtstag" });
    ...
    view.website = null; view.customerTypeRequiresDecision = true;
