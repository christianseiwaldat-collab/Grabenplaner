...
function normalizeSpec(input = {}) {
  ...
  return {
    type,
    confirmationMode: input.confirmationMode === "management" ? "management" : "witness",
...
function render(spec, preparedLogo) {
  return new Promise((resolve, reject) => {
    ...
    detail(
      spec.type === "return"
        ? (spec.confirmationMode === "management" ? "Abschluss durch Filialleitung" : "Gegenprüfung durch")
        : "Belegstatus",
      spec.type === "return"
