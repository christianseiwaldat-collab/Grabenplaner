...
} = require("./repositories/personnel-learning");
const {
  createPortalBirthdayPresentationsRepository,
} = require("./repositories/portal-birthday-presentations");
const {
  createStaffAssignmentRequestRepository,
} = require("./repositories/staff-assignment-requests");
const {
...
} = require("./repositories/sales-article-catalog");
const {
  createCrmCustomersRepository,
} = require("./repositories/crm-customers");
const {
  createPersonalActionLogRepository,
} = require("./repositories/personal-action-log");
...
const createApplicationRepositories = Object.freeze(function createApplicationRepositories(access) {
  ...
  return Object.freeze({
    ...
    crmCustomers: createCrmCustomersRepository(access),
    ...
    personalActionLog: createPersonalActionLogRepository(access),
    ...
    personnelLearning: createPersonnelLearningRepository(access),
    portalBirthdayPresentations: createPortalBirthdayPresentationsRepository(access),
    staffAssignmentRequests: createStaffAssignmentRequestRepository(access),
    ...
    salesArticleCatalog: createSalesArticleCatalogRepository(access),
