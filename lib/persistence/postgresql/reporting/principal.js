...
const articlePermissions=require('../../../sales-article-catalog-access').SALES_ARTICLE_CATALOG_PERMISSIONS;
const permissions=[...new Set([...Object.values(A),...Object.values(H),...Object.values(C),...Object.values(require('../../../tradefoto-bestell/access').BESTELL_PERMISSIONS),articlePermissions.ACCESS,articlePermissions.READ])];
