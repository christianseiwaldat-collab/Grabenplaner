...
async function openSalesDevelopmentApplication(options={}){
  ...
  try{
    ...
    const provider=createPostgresqlPersistenceProvider({pool:guarded,catalog:require('./import-work-queues').indexedImportWorkQueues(entries),poolOwnership:'provider'});
