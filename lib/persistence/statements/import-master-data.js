...
const { DATA_IMPORT_COLUMNS } = require('./data-import');
...
const CRM_DATA = { accountNumber: nullable("text"), customerNumber: nullable("text"), customerType: "text", companyName: "text", firstName: "text", lastName: "text",
...
const IMPORT_MASTER_STATEMENTS = Object.freeze({
  reportDictionaryRuns: all('report-dictionary-runs', { scopeId: 'text', profileHash: 'text', limit: 'safe_integer' }, DATA_IMPORT_COLUMNS.RUN),
