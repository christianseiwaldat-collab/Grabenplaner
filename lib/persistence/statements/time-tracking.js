...
const TIME_TRACKING_STATEMENTS = Object.freeze({
  ...
  getActiveXoffiDay: queryOne("get-active-xoffi-day"),
  listActiveXoffiWeekRows: queryAll("list-active-xoffi-week-rows"),
  listActiveXoffiWeekDays: queryAll("list-active-xoffi-week-days"),
  listLatestXoffiBalances: queryAll("list-latest-xoffi-balances"),
  supersedeActiveXoffiImport: execute("supersede-active-xoffi-import"),
  insertXoffiImport: execute("insert-xoffi-import", true),
  insertXoffiEmployeeRow: execute("insert-xoffi-employee-row", true),
  insertXoffiDay: execute("insert-xoffi-day"),
