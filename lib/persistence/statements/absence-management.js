...
const ABSENCE_MANAGEMENT_STATEMENTS = Object.freeze({
  ...
  activeEmployeeLendingsForRange: queryAll("active-employee-lendings-for-range", DATA_QUERY),
  locationTimeOffConfiguration: queryOne("location-time-off-configuration", DATA_QUERY),
