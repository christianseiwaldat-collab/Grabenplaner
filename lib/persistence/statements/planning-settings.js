...
const PLANNING_SETTINGS_STATEMENTS = Object.freeze({
  ...
  listLocationDashboardVacations: queryAll("location-dashboard.vacations"),
  ...
  listScheduleLendings: queryAll("schedule.employee-lendings"),
  ...
  listAutoPlanningEmployeeShifts: queryAll("auto-planning.employee-shifts"),
