...
const { CASH_SNAPSHOT_COLUMNS, CASH_SNAPSHOT_TABLES } = require('./cash-snapshots');
...
const S = Object.freeze({
  ...
  search: Object.freeze(Object.fromEntries(['Umsatz_Kasse_Details', 'Tagesbericht', 'KassenJournal_Details', 'Umsatz_KASSE'].map(name => [name,
    def('search.' + CASH_SNAPSHOT_TABLES.findIndex(t => t.name === name), 'queryAll', {
