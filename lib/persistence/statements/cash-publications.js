...
const S = Object.freeze({
  reportSourceSearch: def('report-source-search', 'queryAll', { datasetSlot: 'safe_integer', locationKey: nullable('bytes'),
    dateFrom: 'date', dateTo: 'date', afterDate: 'date', afterRow: 'safe_integer', limit: 'safe_integer' }, { sourceRow: 'safe_integer', businessDate: 'date' }),
