"use strict";
const { SQLITE_SALES_ARTICLE_IMAGES_CATALOG } = require('./sales-article-images-catalog');
const { SQLITE_SALES_REPORT_JOBS_CATALOG } = require('./sales-report-jobs-catalog');
const { SQLITE_DATA_IMPORT_CATALOG } = require("./data-import-catalog");
const { SQLITE_IMPORT_MASTER_CATALOG } = require("./import-master-catalog");
const { SQLITE_IMPORT_HISTORY_CATALOG } = require("./import-history-catalog");
const { SQLITE_DATA_IMPORT_RUNTIME_CATALOG } = require("./data-import-runtime-catalog");
...
const { SQLITE_SATURDAY_CREDIT_CATALOG } = require("./saturday-credit-catalog");
...
} = require("./personal-notification-contacts-catalog");
const {
  SQLITE_PERSONNEL_LIFECYCLE_CATALOG,
} = require("./personnel-lifecycle-catalog");
const {
...
} = require("./staff-assignment-request-catalog");
const {
...
} = require("./sales-analytics-catalog");
const {
  SQLITE_SALES_ARTICLE_CATALOG,
} = require("./sales-article-catalog-catalog");
const {
  SQLITE_CRM_CUSTOMERS_CATALOG,
} = require("./crm-customers-catalog");
const {
  SQLITE_PERSONAL_ACTION_LOG_CATALOG,
} = require("./personal-action-log-catalog");
const {
...
const SQLITE_APPLICATION_CATALOG = createSqliteApplicationCatalog(
  require('./data-import-delete-catalog').CATALOG,
  require('./sales-article-workspace-catalog').CATALOG,
  require('./xoffi-snapshots-catalog').CATALOG,
  require('./personnel-learning-runs-catalog').CATALOG,
  require('./branch-article-stock-catalog').BRANCH_ARTICLE_STOCK_CATALOG,
  require('./branch-receipt-catalog').BRANCH_RECEIPT_CATALOG,
  require('./trade-insights-catalog').TRADE_INSIGHTS_CATALOG,
  require('./trade-annotations-catalog').TRADE_ANNOTATIONS_CATALOG,
  SQLITE_DATA_IMPORT_CATALOG,
  SQLITE_IMPORT_MASTER_CATALOG,
  SQLITE_IMPORT_HISTORY_CATALOG,
  SQLITE_DATA_IMPORT_RUNTIME_CATALOG,
  SQLITE_CASH_SNAPSHOTS_CATALOG,
  SQLITE_CASH_PUBLICATIONS_CATALOG,
  SQLITE_SALES_REPORT_JOBS_CATALOG,
  SQLITE_SATURDAY_CREDIT_CATALOG,
  SQLITE_ABSENCE_MANAGEMENT_CATALOG,
  SQLITE_BRANDING_SNAPSHOT_CATALOG,
  SQLITE_COLLECTIVE_AGREEMENTS_CATALOG,
  SQLITE_CRM_CUSTOMERS_CATALOG,
  ...
  SQLITE_RUNTIME_RECOVERY_CATALOG,
  SQLITE_SALES_ARTICLE_CATALOG,
  SQLITE_SALES_ARTICLE_IMAGES_CATALOG,
  SQLITE_SALES_ANALYTICS_CATALOG,
  SQLITE_SICKNESS_AMU_MANAGEMENT_CATALOG,
  SQLITE_SYSTEM_CENTER_METRICS_CATALOG,
  SQLITE_TIME_TRACKING_CATALOG,
