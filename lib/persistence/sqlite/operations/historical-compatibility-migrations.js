...
ensureColumn("time_off_requests", "origin_location_id", "TEXT");
ensureColumn("time_off_requests", "review_department_id", "INTEGER");
ensureColumn("time_off_requests", "lending_id", "TEXT");
...
ensureColumn("time_off_change_requests", "origin_location_id", "TEXT");
ensureColumn("time_off_change_requests", "review_department_id", "INTEGER");
ensureColumn("time_off_change_requests", "lending_id", "TEXT");
