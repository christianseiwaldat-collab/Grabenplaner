...
const PERSONNEL_LIFECYCLE_PROFILE_PHOTO_CATEGORY_MIGRATION_ID =
  "v0.92.18-personnel-lifecycle-profile-photo-category";
const PERSONNEL_PROFILE_SCOPED_RIGHTS_MIGRATION_ID = "v0.90-personnel-profile-scoped-rights";
const PERSONNEL_LIFECYCLE_OPERATIONAL_SCOPED_RIGHTS_MIGRATION_ID =
  "v0.90-personnel-lifecycle-operational-scoped-rights";
...
const PERSONNEL_PROFILE_SCOPED_RIGHTS_TABLE_DEFINITION = tableDefinition(
  "portal_permission_scope_grants",
  `
    CREATE TABLE IF NOT EXISTS portal_permission_scope_grants (
      employee_number TEXT NOT NULL,
...
function inspectSqlitePersonnelLifecycleScopedRightsCompatibility(database) {
  ...
  const predecessorVersion = [
    ...
    ["profile", PERSONNEL_PROFILE_SCOPED_RIGHTS_TABLE_DEFINITION],
...
function ensureSqlitePersonnelLifecycleSchema(database) {
  ...
  sqliteDatabase.exec(`
    ...
    INSERT INTO candidate_document_categories (
      ...
      ('profile-photo', 'profile_photo', 'Bewerberfoto', 'scoped_leadership', 'manual_review', NULL, 0, 1, 1, 70)
