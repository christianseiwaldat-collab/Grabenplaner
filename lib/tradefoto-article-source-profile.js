...
const TRADEFOTO_ARTICLE_ALIAS_ROW_FIELDS = Object.freeze(["EAN", "ZweitEAN", "Rang"]);
...
const TRADEFOTO_ARTICLE_IMPORT_FORMAT = "grabenplaner.tradefoto.article-catalog.v1";
const TRADEFOTO_ARTICLE_SOURCE_SCHEMA_SHA256 = createHash("sha256")
  .update(JSON.stringify({
    ...
    articleRowFields: TRADEFOTO_ARTICLE_ROW_FIELDS,
    aliasRowFields: TRADEFOTO_ARTICLE_ALIAS_ROW_FIELDS,
    grossNetGate: "vat-codes-0-1-2-3-4-cent-half-up-tolerance-one-cent-v2",
  }))
  .digest("hex");
