...
const metadata = C.freeze({ ...originalMetadata,
  coverage: { tables: originalMetadata.coverage.tables + bestellTables.length,
    fields: originalMetadata.coverage.fields + bestellTables.reduce((n, t) => n + t.columns.length, 0) },
  tables: [...originalMetadata.tables, ...bestellTables] });
