  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      for (const metric of selected) {
        ...
        if (metric === selected[0]) text('Sofortrabatte bleiben bei ihrer eigenen Warengruppe und Marke. Gutscheinausgaben erzeugen keinen Warenumsatz oder Rohertrag. Gutscheineinlösungen sind Zahlungsmittel. Umsatz und Rohertrag entstehen beim Warenkauf. UID-Zwischenbuchungen betreffen die Zahlungsabwicklung ohne Warenumsatz oder Rohertrag. Rabatt-, Gutschein- und Verrechnungspositionen zählen nicht als verkaufte Stücke.', { size: 8 });
