...
const CATALOG_VERSION = "at-work-rules-2026.2";
const ADULT_CATALOG_VERSION = "at-work-rules-2026.1";
...
const SOURCE_CATALOG = Object.freeze({
  ...
  "ris.kjbg.1": Object.freeze({
    id: "ris.kjbg.1",
    jurisdiction: "AT",
    title: "Kinder- und Jugendlichen-Beschäftigungsgesetz (KJBG) § 1 – Geltungsbereich",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=1",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.11": Object.freeze({
    id: "ris.kjbg.11",
    jurisdiction: "AT",
    title: "KJBG § 11 – Arbeitszeit und Berufsschule",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=11",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.12": Object.freeze({
    id: "ris.kjbg.12",
    jurisdiction: "AT",
    title: "KJBG § 12 – Überstunden",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=12",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.15": Object.freeze({
    id: "ris.kjbg.15",
    jurisdiction: "AT",
    title: "KJBG § 15 – Ruhepausen",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=15",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.16": Object.freeze({
    id: "ris.kjbg.16",
    jurisdiction: "AT",
    title: "KJBG § 16 – Tägliche Ruhezeit",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=16",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.17": Object.freeze({
    id: "ris.kjbg.17",
    jurisdiction: "AT",
    title: "KJBG § 17 – Nachtruhe",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=17",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.18": Object.freeze({
    id: "ris.kjbg.18",
    jurisdiction: "AT",
    title: "KJBG § 18 – Sonn- und Feiertagsruhe",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=18",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.19": Object.freeze({
    id: "ris.kjbg.19",
    jurisdiction: "AT",
    title: "KJBG § 19 – Wochenfreizeit",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=19",
    retrievedOn: "2026-07-25",
  }),
  "ris.kjbg.19a": Object.freeze({
    id: "ris.kjbg.19a",
    jurisdiction: "AT",
    title: "KJBG § 19a – Sonderregelungen für Verkaufsstellen",
    url: "https://www.ris.bka.gv.at/NormDokument.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10008632&Paragraf=19a",
    retrievedOn: "2026-07-25",
  }),
...
const RULE_DEFINITIONS = Object.freeze({
  ...
  "at.applicability.youth": Object.freeze({
    id: "at.applicability.youth",
    title: "Anwendbarkeit des Jugendprofils",
    severity: "warning",
    enforcement: "manual_review",
    sourceRefs: Object.freeze(["ris.kjbg.1"]),
  }),
  "at.kjbg.normal.daily": Object.freeze({
    id: "at.kjbg.normal.daily",
    title: "Tägliche Arbeitszeit Jugendlicher",
    severity: "error",
    enforcement: "exception_required",
    sourceRefs: Object.freeze(["ris.kjbg.11", "ris.kjbg.12"]),
  }),
  "at.kjbg.normal.weekly": Object.freeze({
    id: "at.kjbg.normal.weekly",
    title: "Wöchentliche Arbeitszeit Jugendlicher",
    severity: "error",
    enforcement: "exception_required",
    sourceRefs: Object.freeze(["ris.kjbg.11", "ris.kjbg.12"]),
  }),
  "at.kjbg.break.after-four-half": Object.freeze({
    id: "at.kjbg.break.after-four-half",
    title: "Ruhepause Jugendlicher",
    severity: "error",
    enforcement: "block",
    sourceRefs: Object.freeze(["ris.kjbg.15"]),
  }),
  "at.kjbg.daily-rest": Object.freeze({
    id: "at.kjbg.daily-rest",
    title: "Tägliche Ruhezeit Jugendlicher",
    severity: "critical",
    enforcement: "block",
    sourceRefs: Object.freeze(["ris.kjbg.16"]),
  }),
  "at.kjbg.night-work": Object.freeze({
    id: "at.kjbg.night-work",
    title: "Nachtruhe Jugendlicher",
    severity: "critical",
    enforcement: "block",
    sourceRefs: Object.freeze(["ris.kjbg.17"]),
  }),
  "at.kjbg.sunday-holiday-work": Object.freeze({
    id: "at.kjbg.sunday-holiday-work",
    title: "Sonn- und Feiertagsruhe Jugendlicher",
    severity: "critical",
    enforcement: "block",
    sourceRefs: Object.freeze(["ris.kjbg.18"]),
  }),
  "at.kjbg.retail.saturday-monday": Object.freeze({
    id: "at.kjbg.retail.saturday-monday",
    title: "Wochenfreizeit nach Samstagsdienst",
    severity: "critical",
    enforcement: "exception_required",
    sourceRefs: Object.freeze(["ris.kjbg.19"]),
  }),
  "at.kjbg.retail.consecutive-saturdays": Object.freeze({
    id: "at.kjbg.retail.consecutive-saturdays",
    title: "Aufeinanderfolgende Samstagnachmittage",
    severity: "critical",
    enforcement: "exception_required",
    sourceRefs: Object.freeze(["ris.kjbg.19a"]),
  }),
  "at.kjbg.retail.saturday-after-18": Object.freeze({
    id: "at.kjbg.retail.saturday-after-18",
    title: "Samstagsdienst Jugendlicher nach 18 Uhr",
    severity: "critical",
    enforcement: "block",
    sourceRefs: Object.freeze(["ris.kjbg.19a"]),
  }),
...
const PROFILE_CATALOG = Object.freeze({
  "at-general-adult": Object.freeze({
    id: "at-general-adult",
    version: "2026.1",
    catalogVersion: ADULT_CATALOG_VERSION,
  ...
  "at-retail-youth-monitor": Object.freeze({
    id: "at-retail-youth-monitor",
    version: "2026.2",
    catalogVersion: CATALOG_VERSION,
    title: "Österreich – Handel, Jugend- und Lehrlingsprofil unter 18",
    status: "active",
    assignable: false,
    validFrom: CATALOG_EFFECTIVE_FROM,
    validTo: null,
    applicability: Object.freeze({
      ...
      note: "Das Profil wird bei bestätigtem Geburtsdatum für Beschäftigte unter 18 automatisch verwendet.",
    }),
    defaultEnforcementMode: "monitor",
    limits: Object.freeze({
      normalDailyMinutes: 8 * 60,
      normalWeeklyMinutes: 40 * 60,
      maximumDailyMinutesUnder16: 9 * 60,
      maximumWeeklyMinutesUnder16: 45 * 60,
      maximumDailyMinutesFrom16: 9.5 * 60,
      maximumWeeklyMinutesFrom16: 47.5 * 60,
      breakTriggerMinutes: 4.5 * 60,
      breakRequiredMinutes: 30,
      dailyRestMinutesUnder15: 14 * 60,
      dailyRestMinutes: 12 * 60,
      nightStartMinute: 20 * 60,
      nightEndMinute: 6 * 60,
      saturdaySalesEndMinute: 18 * 60,
    }),
    ruleIds: Object.freeze([
      "at.applicability.youth",
      "at.kjbg.normal.daily",
      "at.kjbg.normal.weekly",
      "at.kjbg.break.after-four-half",
      "at.kjbg.daily-rest",
      "at.kjbg.night-work",
      "at.kjbg.sunday-holiday-work",
      "at.kjbg.retail.saturday-monday",
      "at.kjbg.retail.consecutive-saturdays",
      "at.kjbg.retail.saturday-after-18",
    ]),
    sourceRefs: Object.freeze([
      "ris.kjbg.1", "ris.kjbg.11", "ris.kjbg.12", "ris.kjbg.15",
      "ris.kjbg.16", "ris.kjbg.17", "ris.kjbg.18", "ris.kjbg.19", "ris.kjbg.19a",
    ]),
  }),
