...
function branchReceiptProjection(session) {
  const { locationId } = branchSalesContext(session, BRANCH_RECEIPTS_PERMISSION);
  return Object.freeze({ read: true, sellers: false, customerPurchases: false,
    finance: false, unassigned: false, company: false, locationIds: Object.freeze([locationId]) });
}
