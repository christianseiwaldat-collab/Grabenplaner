...
- Die AUM-Texterkennung läuft lokal im Browser. OCR-Rohtext wird weder an den Server übertragen noch in der Datenbank gespeichert; vorgeschlagene Datumswerte müssen vor dem Upload bestätigt werden.
