(function attachFunctionSearchCatalog(root, factory) {
  ...
  const FUNCTION_SEARCH_CATALOG = [
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Urlaub", "Freigabeworkflow"],
      ...
      ["settingsPersonnelTab", "vacationSettings", "workflowSettingsCard"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Urlaub", "Vertretung"],
      ...
      ["settingsPersonnelTab", "vacationSettings", "delegationSettingsCard"],
      { view: "settings", settingsTab: "vacation", focusId: "delegationSettingsCard" },
    ),
    entry(
      "settings.break-rule",
      "Pausenregel einstellen",
      ["Einstellungen", "Personal", "Zeiterfassung", "Pausenregel"],
      ...
      ["settingsPersonnelTab", "timeTrackingSettings", "breakRuleEnabled"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Zeiterfassung", "WLAN-Zeitvorschläge"],
      ...
      ["settingsPersonnelTab", "timeTrackingSettings", "wifiSettingsCard"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Direkte Verbindungen"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "integrationConnectionsCard"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Schnittstellenverträge"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "integrationContractsCard"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Personalimport"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "employeeImportCard"],
      { view: "settings", settingsTab: "integrations", focusId: "employeeImportCard" },
    ),
    entry(
      "settings.import-profiles",
      "Importprofile anzeigen",
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Importprofile"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "importProfileCard"],
      { view: "settings", settingsTab: "integrations", focusId: "importProfileCard" },
    ),
    entry(
      "settings.payroll-export",
      "Lohnverrechnung vorbereiten",
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Lohnexport"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "payrollExportCard"],
      { view: "settings", settingsTab: "integrations", focusId: "payrollExportCard" },
    ),
    entry(
      "settings.payroll-handoffs",
      "Monatsübergaben anzeigen",
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Monatsübergaben"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "payrollHandoffCard"],
      { view: "settings", settingsTab: "integrations", focusId: "payrollHandoffCard" },
    ),
    entry(
      "settings.export-profiles",
      "Exportprofile anzeigen",
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Exportprofile"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "exportProfileCard"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Information"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "integrationInformationCard"],
    ...
    entry(
      ...
      ["Einstellungen", "Personal", "Import & Lohnverrechnung", "Historie"],
      ...
      ["settingsPersonnelTab", "integrationSettings", "integrationHistoryCard"],
    ...
    entry(
      "settings.database-imports",
      "Datenbankimporte öffnen",
      ["Einstellungen", "System & Backups", "Datenbankimporte"],
      "Öffnet die zentrale Prüfung und Übernahme der Kassen-, TradeFoto- und Bestelldateien.",
      ["accdb", "access datenbank", "datenbankimport", "kassa import", "trade daten", "trade datenbestell", "kassen umsätze", "artikel import"],
      ["settingsBackupTab", "databaseImportSettings"],
      { view: "settings", settingsTab: "databaseImports", focusId: "databaseImportSettings" },
    ),
  ];
