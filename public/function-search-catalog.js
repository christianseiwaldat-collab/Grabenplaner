(function attachFunctionSearchCatalog(root, factory) {
  ...
  const FUNCTION_SEARCH_CATALOG = [
    ...
    entry(
      ...
      ["Einstellungen", "Grundeinstellungen", "Bearbeitungssperre"],
      ...
      ["settingsGeneralTab", "currentWeekLockSettings"],
      { view: "settings", settingsTab: "general", focusId: "currentWeekLockSettings" },
    ),
    entry(
      "settings.loans",
