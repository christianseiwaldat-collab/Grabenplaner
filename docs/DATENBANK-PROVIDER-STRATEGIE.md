...
abgeschlossen. Sämtliche 1348 Anwendungsstatements besitzen eine eindeutige
...
absichtlich nicht ausführbar. Er umfasst alle 1348 Anwendungsstatements: 1233
Einträge sind generierte Syntaxkandidaten (`portable-generated`), 115
benötigen eine ausdrückliche `requires-override`-Implementierung und 0 von 1348
bilden einen ausführbaren Vollanwendungskatalog.

Der neue Katalogvertrag verhindert bei derzeit 0/1348 akzeptierten Live- und
Paritätsnachweisen jeden für die Vollanwendung ausführbaren Katalog. Auch 1348
strukturell vollständige Deklarationen reichen ohne diese 1348
...
Produktaktivierung und verändern den Stand 0/1348 nicht.
...
aber keines dieser Phase-5-Gates: Der Vollanwendungsstand bleibt 0/1348 und der
...
- [ ] die Phase-5-Gates 1348/1348 und 10/10 sind erfüllt;
...
PostgreSQL-Vollkatalog und Anwendungsmigrationen stehen weiterhin bei 0/1348
