...
abgeschlossen. Sämtliche 1148 Anwendungsstatements besitzen eine eindeutige
...
absichtlich nicht ausführbar. Er umfasst alle 1148 Anwendungsstatements: 1034
Einträge sind generierte Syntaxkandidaten (`portable-generated`), 114
benötigen eine ausdrückliche `requires-override`-Implementierung und 0 von 1148
bilden einen ausführbaren Vollanwendungskatalog.

Der neue Katalogvertrag verhindert bei derzeit 0/1148 akzeptierten Live- und
Paritätsnachweisen jeden für die Vollanwendung ausführbaren Katalog. Auch 1148
strukturell vollständige Deklarationen reichen ohne diese 1148
...
Produktaktivierung und verändern den Stand 0/1148 nicht.
...
aber keines dieser Phase-5-Gates: Der Vollanwendungsstand bleibt 0/1148 und der
...
- [ ] die Phase-5-Gates 1148/1148 und 10/10 sind erfüllt;
...
PostgreSQL-Vollkatalog und Anwendungsmigrationen stehen weiterhin bei 0/1148
