...
abgeschlossen. Sämtliche 1159 Anwendungsstatements besitzen eine eindeutige
...
absichtlich nicht ausführbar. Er umfasst alle 1159 Anwendungsstatements: 1045
Einträge sind generierte Syntaxkandidaten (`portable-generated`), 114
benötigen eine ausdrückliche `requires-override`-Implementierung und 0 von 1159
bilden einen ausführbaren Vollanwendungskatalog.

Der neue Katalogvertrag verhindert bei derzeit 0/1159 akzeptierten Live- und
Paritätsnachweisen jeden für die Vollanwendung ausführbaren Katalog. Auch 1159
strukturell vollständige Deklarationen reichen ohne diese 1159
...
Produktaktivierung und verändern den Stand 0/1159 nicht.
...
aber keines dieser Phase-5-Gates: Der Vollanwendungsstand bleibt 0/1159 und der
...
- [ ] die Phase-5-Gates 1159/1159 und 10/10 sind erfüllt;
...
PostgreSQL-Vollkatalog und Anwendungsmigrationen stehen weiterhin bei 0/1159
