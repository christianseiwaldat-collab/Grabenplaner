...
abgeschlossen. Sämtliche 1135 Anwendungsstatements besitzen eine eindeutige
...
absichtlich nicht ausführbar. Er umfasst alle 1135 Anwendungsstatements: 1021
Einträge sind generierte Syntaxkandidaten (`portable-generated`), 114
benötigen eine ausdrückliche `requires-override`-Implementierung und 0 von 1135
bilden einen ausführbaren Vollanwendungskatalog.

Der neue Katalogvertrag verhindert bei derzeit 0/1135 akzeptierten Live- und
Paritätsnachweisen jeden für die Vollanwendung ausführbaren Katalog. Auch 1135
strukturell vollständige Deklarationen reichen ohne diese 1135
...
Produktaktivierung und verändern den Stand 0/1135 nicht.
...
aber keines dieser Phase-5-Gates: Der Vollanwendungsstand bleibt 0/1135 und der
...
- [ ] die Phase-5-Gates 1135/1135 und 10/10 sind erfüllt;
...
PostgreSQL-Vollkatalog und Anwendungsmigrationen stehen weiterhin bei 0/1135
