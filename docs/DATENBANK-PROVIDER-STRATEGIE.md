...
abgeschlossen. Sämtliche 928 Anwendungsstatements besitzen eine eindeutige
...
absichtlich nicht ausführbar. Er umfasst alle 928 Anwendungsstatements: 826
Einträge sind generierte Syntaxkandidaten (`portable-generated`), 102
benötigen eine ausdrückliche `requires-override`-Implementierung und 0 von 928
bilden einen ausführbaren Vollanwendungskatalog.

Der neue Katalogvertrag verhindert bei derzeit 0/928 akzeptierten Live- und
Paritätsnachweisen jeden für die Vollanwendung ausführbaren Katalog. Auch 928
strukturell vollständige Deklarationen reichen ohne diese 928
...
Produktaktivierung und verändern den Stand 0/928 nicht.
...
aber keines dieser Phase-5-Gates: Der Vollanwendungsstand bleibt 0/928 und der
...
- [ ] die Phase-5-Gates 928/928 und 9/9 sind erfüllt;
...
PostgreSQL-Vollkatalog und Anwendungsmigrationen stehen weiterhin bei 0/928
