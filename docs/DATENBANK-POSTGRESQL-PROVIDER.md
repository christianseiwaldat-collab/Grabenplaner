...
| [`lib/persistence/postgresql/catalog-contract.js`](../lib/persistence/postgresql/catalog-contract.js) | fail-closed Katalogvertrag für Provenienz, Teil-Slices und das geschlossene 1099er-Acceptance-Gate |
...
| [`test/v087-database-block5-postgresql-catalog-contract.test.js`](../test/v087-database-block5-postgresql-catalog-contract.test.js) | Katalog-, Provenienz-, Teil-Slice- und 0/1099-Acceptance-Gates |
...
nicht ausführbare Gesamtplan umfasst alle 1099 Anwendungsstatements:

- 988 Einträge sind generierte PostgreSQL-Syntaxkandidaten
  (`portable-generated`);
- 111 Einträge benötigen weiterhin eine ausdrückliche
  `requires-override`-Implementierung;
- 0 von 1099 Einträgen bilden einen freigegebenen, für die Anwendung
...
für die Vollanwendung ausführbaren Katalog sind 1099 akzeptierte Live- und
Paritätsnachweise erforderlich; aktuell liegen 0/1099 vor. Deshalb kann selbst
ein strukturell vollständiger Katalog mit 1099 Deklarationen heute nicht
...
Abdeckungen 4/4, 2/2, 2/2 und 1/1 verändern den Vollanwendungsstand von 0/1099
...
| SQL-Katalog | Compiler-v2-Plan mit 988 Syntaxkandidaten und 111 Overrides; geschlossener 0/1099-Acceptance-Vertrag; gepinnte Quellvertrags-Fingerprints aus SQL plus vollständigem Statementvertrag; widersprüchliches `RETURNING` scheitert geschlossen; vier reale Teil-Slices mit zusammen neun Statements: UI-Präferenzen 4/4, Planning Settings 2/2, Organization Departments 2/2 und System Center 1/1 | alle 1099 Anwendungsstatements mit geprüftem PostgreSQL-SQL und je einem akzeptierten Live-/Paritätsnachweis | vollständiger Funktionslauf |
...
0/1099 für den Vollanwendungskatalog und 0/10 für die Anwendungsmigrationen.
...
`productActivation: false`; der Katalogvertrag verhindert bei 0/1099
...
- dass der nicht ausführbare Gesamtplan oder alle 988 generierten
