...
Der Stand umfasst 1324 Statementverträge, einschließlich 97 zuvor in den
...
| benannte SQLite-Dialektvariante | 1290 | mindestens ein explizites SQLite-Merkmal |
...
`RAISE(ABORT)` geführt. 1217 der 1290 Varianten verwenden die in der
...
Die PostgreSQL-Fixture besitzt für alle 1324 Statement-IDs denselben Eigentümer
...
- vollständige und eindeutige Bindung aller 1324 Statements;
...
Der ergänzte PostgreSQL-Dialektplan ist nicht ausführbar und umfasst alle 1324
Anwendungsstatements:

- Compiler v2 erzeugt 1210 Syntaxkandidaten (`portable-generated`);
- 114 Einträge bleiben `requires-override`;
- 0 von 1324 bilden einen ausführbaren Vollanwendungskatalog.
...
Katalog 1324 akzeptierte Live- und Paritätsnachweise. Der aktuelle Stand ist
0/1324; deshalb bleiben selbst 1324 strukturell vollständige Deklarationen ohne
...
Teilnachweise verändern den Vollanwendungsstand 0/1324 nicht und sind keine
...
geschlossenen Vollanwendungsplan auf 1324 Statements. Compiler v2 klassifiziert
1210 davon als `portable-generated`; 114 benötigen `requires-override`. Ohne
akzeptierte Live- und Paritätsreceipts bleibt der PostgreSQL-Stand 0/1324; die
