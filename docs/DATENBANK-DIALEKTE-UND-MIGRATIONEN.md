...
Der Stand umfasst 1117 Statementverträge in 25 Fachbereichen. Die
...
| benannte SQLite-Dialektvariante | 1084 | mindestens ein explizites SQLite-Merkmal |
...
`RAISE(ABORT)` geführt. 1011 der 1084 Varianten verwenden die in der
...
Die PostgreSQL-Fixture besitzt für alle 1117 Statement-IDs denselben Eigentümer
...
- vollständige und eindeutige Bindung aller 1117 Statements;
...
Der ergänzte PostgreSQL-Dialektplan ist nicht ausführbar und umfasst alle 1117
Anwendungsstatements:

- Compiler v2 erzeugt 1006 Syntaxkandidaten (`portable-generated`);
- 111 Einträge bleiben `requires-override`;
- 0 von 1117 bilden einen ausführbaren Vollanwendungskatalog.
...
Katalog 1117 akzeptierte Live- und Paritätsnachweise. Der aktuelle Stand ist
0/1117; deshalb bleiben selbst 1117 strukturell vollständige Deklarationen ohne
...
Teilnachweise verändern den Vollanwendungsstand 0/1117 nicht und sind keine
...
geschlossenen Vollanwendungsplan auf 1117 Statements. Compiler v2 klassifiziert
1006 davon als `portable-generated`; 111 benötigen `requires-override`. Ohne
akzeptierte Live- und Paritätsreceipts bleibt der PostgreSQL-Stand 0/1117; die
