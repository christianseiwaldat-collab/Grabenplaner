...
Der Stand umfasst 1115 Statementverträge in 25 Fachbereichen. Die
...
| benannte SQLite-Dialektvariante | 1082 | mindestens ein explizites SQLite-Merkmal |
...
`RAISE(ABORT)` geführt. 1009 der 1082 Varianten verwenden die in der
...
Die PostgreSQL-Fixture besitzt für alle 1115 Statement-IDs denselben Eigentümer
...
- vollständige und eindeutige Bindung aller 1115 Statements;
...
Der ergänzte PostgreSQL-Dialektplan ist nicht ausführbar und umfasst alle 1115
Anwendungsstatements:

- Compiler v2 erzeugt 1004 Syntaxkandidaten (`portable-generated`);
- 111 Einträge bleiben `requires-override`;
- 0 von 1115 bilden einen ausführbaren Vollanwendungskatalog.
...
Katalog 1115 akzeptierte Live- und Paritätsnachweise. Der aktuelle Stand ist
0/1115; deshalb bleiben selbst 1115 strukturell vollständige Deklarationen ohne
...
Teilnachweise verändern den Vollanwendungsstand 0/1115 nicht und sind keine
...
geschlossenen Vollanwendungsplan auf 1115 Statements. Compiler v2 klassifiziert
1004 davon als `portable-generated`; 111 benötigen `requires-override`. Ohne
akzeptierte Live- und Paritätsreceipts bleibt der PostgreSQL-Stand 0/1115; die
