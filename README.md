...
<p align="center">
  <strong>v0.78.1 Beta</strong> · Windows · Ubuntu-Server · SQLite · Source-available
</p>
...
1. Die portable ZIP-Datei unter [Grabenplaner v0.78.1 Beta](https://github.com/christianseiwaldat-collab/Grabenplaner/releases/tag/v0.78.1-beta) herunterladen und entpacken.
2. `Grabenplaner v0.78.1 Beta starten.cmd` doppelt anklicken.
