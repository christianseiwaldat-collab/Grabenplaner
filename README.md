...
**v0.90.4 Beta · verwalteter Ubuntu-Einzelserver · SQLite · source-available**

[Server-Release v0.90.4 Beta](https://github.com/christianseiwaldat-collab/Grabenplaner/releases/tag/v0.90.4-beta) · [Serverbetrieb](SERVERBETRIEB.md) · [Sicherheit](SECURITY.md)
