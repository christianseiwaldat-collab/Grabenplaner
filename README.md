...
**v0.91.0 Beta · verwalteter Ubuntu-Einzelserver · SQLite · source-available**

[Server-Release v0.91.0 Beta](https://github.com/christianseiwaldat-collab/Grabenplaner/releases/tag/v0.91.0-beta) · [Serverbetrieb](SERVERBETRIEB.md) · [Sicherheit](SECURITY.md)
