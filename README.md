...
**v0.90 Beta · verwalteter Ubuntu-Einzelserver · SQLite · source-available**

[Server-Release v0.90 Beta](https://github.com/christianseiwaldat-collab/Grabenplaner/releases/tag/v0.90.0-beta) · [Serverbetrieb](SERVERBETRIEB.md) · [Sicherheit](SECURITY.md)
...
<table>
  <tr>
    <td><img src="docs/readme/dienstplanung.webp" alt="Dienstplanung in Grabenplaner v0.90"></td>
    <td><img src="docs/readme/teams-standorte.webp" alt="Personal- und Kostenstellenverwaltung in Grabenplaner v0.90"></td>
  </tr>
  <tr>
    <td><img src="docs/readme/rechtemanagement.webp" alt="Rollen und wirksame Bereiche in Grabenplaner v0.90"></td>
    <td><img src="docs/readme/branding-kits.webp" alt="Neutrales Branding in Grabenplaner v0.90"></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/readme/mitarbeiterportal.webp" alt="Mobiles Mitarbeiterportal in Grabenplaner v0.90" width="300"></td>
