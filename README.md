...
<p align="center">
  <strong>v0.78.2 Beta</strong> · Windows · Ubuntu-Server · SQLite · Source-available
</p>
...
1. Die portable ZIP-Datei unter [Grabenplaner v0.78.2 Beta](https://github.com/christianseiwaldat-collab/Grabenplaner/releases/tag/v0.78.2-beta) herunterladen und entpacken.
2. `Grabenplaner v0.78.2 Beta starten.cmd` doppelt anklicken.
