...
const PROTECTED_COLUMNS = new Set([
  ...
  "personnel_learning_assessment_records.protected_payload",
...
const PROTECTED_ROW_TABLES = Object.freeze([
  ...
  "personnel_learning_assessment_records",
  "candidate_events",
...
const PROTECTED_DELETE_TRIGGERS = Object.freeze({
  ...
  trg_learning_assessment_no_delete: "personnel_learning_assessment_records",
